      ...
      <div class="hobby-list">
        {#each hobbies as hobby}
          <div class="hobby-card">
            ...
            <img class="hobby-draw" src={hobby.icon} alt={hobby.title + ' illustration'} />
          </div>
        {/each}
      </div>
    </div>
...
<style>
  ...
  .about-img {
    ...
    background: #e7ecd6;
    box-shadow: 0 2px 18px rgba(108,123,62,0.08);
  }
  .about-bio {
    flex: 1;
    color: #333;
